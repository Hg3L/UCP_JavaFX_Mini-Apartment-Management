...
public class cardRoomController implements Initializable {
    ...
    /*---------------------Khai báo hỗ trợ---------------------*/
    private double priceRoom; // Dùng để lưu giá trị tiền được chuyển đổi từ String
    public static String idRoom = ""; // Dùng để lấy mã phòng khi người dùng ấn vào nút trên ô
    /*---------------------------------------------------------*/
	...
	public void addTenant(ActionEvent event) {
    	idRoom = roomIDLabel.getText(); // Lấy mã phòng
		try {
