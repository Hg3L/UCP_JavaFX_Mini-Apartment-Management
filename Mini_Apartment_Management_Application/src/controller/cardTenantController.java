...
public class cardTenantController implements Initializable{
    ...
    // Phương thức cập nhật thông tin chủ phòng
	...
	// Phương thức thêm thành viên phòng (Nút "Thêm")
	@FXML
	...
	// Phương thức cập nhập thành viên 
	...
	public void deleteAll() {
		// Danh sách hỗ trợ kiểm tra xem khách có hóa đơn chưa, nếu có rồi thì không thể xóa
		for(Bill x : Support.billList) {
			if(getRoomIDLabel1.getText().equals(x.getRoomID())) {
